...
# Usage: /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/USER/installer/main/installer.sh)"
# =========================================================================
...
# =========================================================================
# 📥 Download and Execute - FIXED VERSION
# =========================================================================
...
download_and_execute() {
    ...
    # Download private installer - FIXED COMMAND
